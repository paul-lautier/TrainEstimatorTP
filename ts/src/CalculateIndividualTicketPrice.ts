...
export class CalculateIndividualTicketPrice {
	...
	async calculateIndividualTicketPrice(
		...
		if (passenger.discounts.includes(DiscountCard.Family)) {
			return individualTicketPrice * 0.7;
		}
		...
		if (passenger.age <= 17) {
			individualTicketPrice = individualTicketPrice * 0.6;
			...
			individualTicketPrice = individualTicketPrice * 1.2;
		}
		...
		if (daysDifference >= 5 && daysDifference <= 30) {
			individualTicketPrice -= (20 - daysDifference) * 0.02 * individualTicketPrice;
